...
at **189 tests, 0 skipped, 0 failures** — the Metal kernel tests run on the node's GPU
...
python3 tools/check_status_claims.py --swift-tests 189 --swift-skipped 0 --python-tests 288
...
- **The public status of this repository has swung three times, and only the latest is
  ...
  build is clean and **189 Swift tests pass**, while on the `macos-26` CI image (Xcode
