...
at **114 tests, 2 skipped, 0 failures** (the skips are the Metal kernel tests, which
...
- **The public status of this repository has swung three times, and only the latest is
  ...
  build is clean and **114 Swift tests pass**, while on the `macos-26` CI image (Xcode
