...
`swift test --no-parallel` runs **184 tests, 0 skipped, 0 failures** (the skips are the
Metal kernels, which need a GPU), with **211** standard-library Python tests run in CI.
