...
`swift test --no-parallel` runs **178 tests, 2 skipped, 0 failures** (the skips are the
Metal kernels, which need a GPU), with **200** standard-library Python tests run in CI.
